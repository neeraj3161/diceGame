...
function player1(){
   document.querySelector('.img1').src="neeraj3161/diceGame/images/dice"+rounded1+".png";
   return rounded1;
}
function player2(){
   document.querySelector('.img2').src="neeraj3161/diceGame/images/dice"+rounded2+".png";
   return rounded2;
}
function won(){
